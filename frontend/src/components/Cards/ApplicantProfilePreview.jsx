...
const ApplicantProfilePreview = ({
  ...
  const onChangeStatus = async (e) => {
    ...
    try {
      ...
      // Optionally revrt status if failed
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            {selectedApplicant.applicant.avatar ? (
              ...
              <div className="h-20 w-20 rounded-full bg-blue-100 flex items-center justfy-center mx-auto">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gra-600">Status:</span>
                  <StatusBadge status={currentStatus} />
                </div>
                <div className="flex justify-betwwen">
                  <span className="text-gra-600">Applied Date:</span>
                  <span className="text-gra-900">
