            ...
            <div className="flex flex-row items-center justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Manage your job posting and track application
                </p>
              </div>
              <button
                        ...
                        : paginatedJobs.map((job) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-5 whitespace-nowrap min-w-[120px] sm:min-w-0">
                                <span
                                  className={`inline-flex px-3 py-1.5 font-semibold rounded-full ${
                                    job.status === "Active"
                                ...
                                <div className="flex space-x-2">
                                  ...
                                  {job.status === "Active" ? (
                                    <button
                                      ...
                                      className="flex items-center gap-2 text-xs text-orange-600 hover:text-orange-800 p-2 rounded-lg hover:bg-orange-50 transition-colors dration-200"
                                    >
                                      <X className="w-4 h-4" />
