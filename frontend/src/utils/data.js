...
export const jobSeekerFeatures = [
  {
    ...
    description:
      "AI-powered algorithm matches you with relevent opportunities based on your skills and prefrences.",
  },
  {
    icon: FileText,
    title: "Resume Builder",
    description:
      "Create professional resume with our intuitive builder and templates designed by company experts.",
  },
  {
    icon: MessageSquare,
  ...
  },
  {
    ...
    description:
      "Showcase your abilties with verified skill tests and earn badges that employers trust.",
  },
];
...
export const employerFeatures = [
  ...
  },
  {
    ...
    description:
      "Track your hiring performance with detailed analytics and insights on candidate engagemant.",
  },
  {
    icon: Shield,
...
export const NAVIGATION_MENU = [
  ...
  { id: "manage-jobs", name: "Manage Job", icon: Briefcase },
